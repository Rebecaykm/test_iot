                    ...
                    <form action="{{ route('lines.store') }}" method="POST">
                        ...
                        <div class="card-body">
                            <div class="row">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control @error('area_id') is-invalid @enderror"
                                            ...
                                            @foreach($areas as $area)
                                                <option
                                                    value="{{ $area->id }}" {{ old('area_id') == $area->id ? 'selected' : '' }}>
                                                    {{ $area->name }}
                                                </option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label for="color" class="font-weight-bold">Color de la Línea <span
                                                class="text-danger">*</span></label>
                                        <select class="form-control @error('color') is-invalid @enderror" id="color"
                                            ...
                                            @foreach([
                                                ...
                                                <option value="{{ $hex }}"
                                                        {{ old('color') == $hex ? 'selected' : '' }} style="background-color: {{ $hex }};">
                                                    {{ $name }}
                                                </option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <div class="stations-container"
                                             style="max-height: 300px; overflow-y: auto; border: 1px solid #ddd; border-radius: 4px; padding: 10px;">
                                            <div class="row">
