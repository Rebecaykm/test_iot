...
@section('content_header')
    <div class="d-flex justify-content-between align-items-center">
        <h1 class="m-0 text-dark">Crear Paro de Línea</h1>
                    ...
                    <form action="{{ route('line-stoppages.store') }}" method="POST">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control @error('type_line_stoppage_id') is-invalid @enderror"
                                            ...
                                            <option value="{{ $type->id }}" {{ old('type_line_stoppage_id') == $type->id ? 'selected' : '' }}>
                                                {{ $type->name }}
                                            </option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control @error('description') is-invalid @enderror"
                                            ...
                                            placeholder="Descripción detallada de la paro">{{ old('description') }}</textarea>
                                        @error('description')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                        ...
                        <div class="card-footer bg-white d-flex justify-content-end py-3">
                            ...
                            <button type="submit" class="btn btn-primary">
                                <i class="fas fa-save mr-1"></i> Guardar Paro de Línea
                            </button>
                        </div>
                    </form>
                </div>
