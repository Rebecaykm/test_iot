...
@section('content_header')
    <div class="d-flex justify-content-between align-items-center flex-wrap gap-3">
        <div>
            <h1 class="m-0 font-weight-bold text-dark" style="font-size: 1.4rem;">Crear Proyecto</h1>
        </div>
                ...
                <div class="row mb-3">
                    <div class="col-md-6 mb-3 mb-md-0">
                        <x-select
                            name="client_id"
                            label="Cliente *"
                            :options="collect([['value' => '', 'label' => 'Seleccione un cliente', 'selected' => !old('client_id')]])
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" name="type" id="type"
                            ...
                            value="{{ old('type') }}" required placeholder="Ej: Automotriz">
                        @error('type')
                            <div class="field-error">{{ $message }}</div>
                        @enderror
                    </div>
                ...
                <div class="row mb-4">
                    <div class="col-md-6 mb-3 mb-md-0">
                        ...
                        <input type="text" name="model" id="model"
                            ...
                            value="{{ old('model') }}" required placeholder="Ej: Modelo X2024">
                        @error('model')
                            <div class="field-error">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" name="prefix" id="prefix"
                            ...
                            value="{{ old('prefix') }}" required placeholder="Ej: PRJ-" maxlength="10">
                        @error('prefix')
                            <div class="field-error">{{ $message }}</div>
                        @enderror
                    </div>
