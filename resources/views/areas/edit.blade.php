...
@section('content_header')
    <div class="d-flex justify-content-between align-items-center flex-wrap" style="gap: 0.75rem;">
        <div>
            <h1 class="m-0 font-weight-bold text-dark" style="font-size: 1.4rem;">Editar Área</h1>
        </div>
    ...
    <div class="card border-0 shadow-sm" style="border-radius: 12px; overflow: hidden;">
        <div class="card-header bg-white py-3" style="border-bottom: 1px solid #e9ecef;">
            <h5 class="mb-0 section-title">
                <i class="fas fa-map mr-2" style="color: #94a3b8;"></i>Información del Área
            </h5>
        </div>
                ...
                <div class="row mb-3">
                    <div class="col-md-6 mb-3 mb-md-0">
                        ...
                        <input type="text" name="code" id="code"
                            ...
                            value="{{ old('code', $area->code) }}" placeholder="Ej: ARE-001">
                        @error('code')
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" name="name" id="name"
                            ...
                            value="{{ old('name', $area->name) }}" required placeholder="Ej: Estampado">
                        @error('name')
                            <div class="field-error">{{ $message }}</div>
                        @enderror
                    </div>
                ...
                <div class="row mb-3">
                    <div class="col-md-12">
                        ...
                        <textarea name="description" id="description" rows="3"
                            ...
                            placeholder="{{ __('Descripción detallada del área') }}">{{ old('description', $area->description) }}</textarea>
                        @error('description')
                            <div class="field-error">{{ $message }}</div>
                        @enderror
                    </div>
