...
@section('content_header')
    <div class="d-flex justify-content-between align-items-center flex-wrap gap-3">
        <div>
            <h1 class="m-0 font-weight-bold text-dark" style="font-size: 1.4rem;">Crear Tag</h1>
            @if ($workCenter)
                ...
                <div class="row mb-3">
                    <div class="col-md-4 mb-3 mb-md-0">
                        ...
                        <input type="text" name="address" id="address"
                            ...
                            value="{{ old('address') }}" required placeholder="Ej: 001A">
                        @error('address')
                    ...
                    <div class="col-md-4 mb-3 mb-md-0">
                        ...
                        <input type="number" step="0.01" name="long" id="long"
                            ...
                            value="{{ old('long') }}" required placeholder="Ej: 16">
                        @error('long')
                            <div class="field-error">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="text" name="value" id="value"
                            ...
                            value="{{ old('value') }}" placeholder="Ej: 100">
                        @error('value')
                            <div class="field-error">{{ $message }}</div>
                        @enderror
                    </div>
                ...
                <div class="row mb-3">
                    <div class="col-md-6 mb-3 mb-md-0">
                        <x-select
                            ...
                            :options="collect([['value' => '', 'label' => 'Seleccione un tipo', 'selected' => !old('tag_type_id')]])
                                ->concat($tagTypes->map(fn ($tagType) => [
                                    'value' => $tagType->id,
                                    'label' => $tagType->name,
                                    'selected' => old('tag_type_id') == $tagType->id,
                                ]))"
                        />
                        @error('tag_type_id')
                            <div class="field-error">{{ $message }}</div>
                    ...
                    <div class="col-md-6">
                        ...
                        <textarea name="description" id="description" rows="1"
                            ...
                            placeholder="Descripción de la etiqueta">{{ old('description') }}</textarea>
                        @error('description')
                            <div class="field-error">{{ $message }}</div>
                        @enderror
                    </div>
