...
@section('content_header')
    <div class="d-flex justify-content-between align-items-center">
        <h1 class="m-0 text-dark">Crear Tag</h1>
            ...
            <div class="col-md-12">
                <div class="card card-primary">
                    <div class="card-header">
                        <h3 class="card-title">Información de la Tag</h3>
                    </div>
                    ...
                    <form action="{{ route('tags.store') }}" method="POST">
                        ...
                        <div class="card-body">
                            <div class="row">
                                <!-- Campo oculto para Work Center -->
                                <input type="hidden" name="work_center" value="{{ $workCenter->id }}">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control @error('tag_type_id') is-invalid @enderror"
                                            ...
                                            @foreach($tagTypes as $tagType)
                                                <option value="{{ $tagType->id }}" {{ old('tag_type_id') == $tagType->id ? 'selected' : '' }}>
                                                    {{ $tagType->name }}
                                                </option>
                                            @endforeach
                                        </select>
                        ...
                        <div class="card-footer bg-white d-flex justify-content-end py-3">
                            ...
                            <button type="submit" class="btn btn-primary">
                                <i class="fas fa-save mr-1"></i> Crear Etiqueta
                            </button>
                        </div>
                    </form>
                </div>
