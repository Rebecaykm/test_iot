...
@section('content_header')
    <div class="d-flex justify-content-between align-items-center">
        <h1 class="m-0 text-dark"><i class="fas fa-recycle mr-2"></i>Crear Scrap</h1>
            ...
            <div class="col-md-12">
                <div class="card card-primary">
                    <div class="card-header">
                        <h3 class="card-title">
                            <i class="fas fa-info-circle mr-2"></i>Información del Scrap
                        </h3>
                    </div>
                    ...
                    <form action="{{ route('scraps.store') }}" method="POST">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control @error('type_scrap_id') is-invalid @enderror"
                                            ...
                                            @foreach($typeScraps as $type)
                                                <option value="{{ $type->id }}" {{ old('type_scrap_id') == $type->id ? 'selected' : '' }}>
                                                    {{ $type->name }}
                                                </option>
                                            @endforeach
                                        </select>
                        ...
                        <div class="card-footer bg-white d-flex justify-content-end py-3">
                            ...
                            <button type="submit" class="btn btn-primary">
                                <i class="fas fa-save mr-1"></i> Crear Scrap
                            </button>
                        </div>
                    </form>
                </div>
