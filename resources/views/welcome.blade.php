<x-guest-layout>
    <div class="flex flex-col" style="height: calc(100vh - var(--header-height, 0px));">
        ...
        <main class="flex-1 overflow-hidden bg-gray-50">
            <!-- Vista del Dashboard -->
            <div id="dashboard-view" class="content-view h-full overflow-y-auto">
                @livewire('guest.work-center-dashboard')
            </div>

            <!-- Vista del Mapa -->
            <div id="map-view" class="content-view h-full hidden">
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            setCorrectHeight();
            switchTab('dashboard'); // Cambiado a 'dashboard' para que muestre las gráficas primero
        });
