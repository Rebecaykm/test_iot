...
@section('content_header')
    <div class="d-flex justify-content-between align-items-center flex-wrap gap-3">
        <div>
            <h1 class="m-0 font-weight-bold text-dark" style="font-size: 1.4rem;">Editar Tipo de Scrap</h1>
        </div>
    ...
    <div class="card border-0 shadow-sm rounded-4 overflow-hidden">
        <div class="card-header bg-white py-3" style="border-bottom: 1px solid #e9ecef;">
            <h5 class="mb-0 section-title">
                <i class="fas fa-tags mr-2" style="color: #94a3b8;"></i>Información del Tipo de Scrap
            </h5>
        </div>
                ...
                <div class="row mb-3">
                    <div class="col-md-12">
                        ...
                        <input type="text" name="name" id="name"
                            ...
                            value="{{ old('name', $typeScrap->name) }}" required placeholder="Ej: Scrap de Plástico">
                        @error('name')
