...
@section('content_header')
    <div class="d-flex justify-content-between align-items-center flex-wrap gap-3">
        <div>
            <h1 class="m-0 font-weight-bold text-dark" style="font-size: 1.4rem;">Crear Usuario</h1>
        </div>
    ...
    <div class="card border-0 shadow-sm rounded-4 overflow-hidden">
        <div class="card-header bg-white py-3" style="border-bottom: 1px solid #e9ecef;">
            <h5 class="mb-0 section-title">
                <i class="fas fa-user-plus mr-2" style="color: #94a3b8;"></i>Información General
            </h5>
        </div>
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-6">
                        <x-select
                            name="role"
                            label="Rol"
                            :options="collect([['value' => '', 'label' => 'Seleccione un rol', 'selected' => !old('role')]])
                ...
                <div class="row mb-4">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="password" name="password_confirmation" id="password_confirmation"
                            class="field-input" required placeholder="Repite la contraseña">
                    </div>
                </div>
