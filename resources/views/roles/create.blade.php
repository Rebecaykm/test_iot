...
@section('content_header')
    <div class="d-flex justify-content-between align-items-center flex-wrap gap-3">
        <div>
            <h1 class="m-0 font-weight-bold text-dark" style="font-size: 1.4rem;">Crear Rol</h1>
        </div>
                ...
                <div class="row mb-3">
                    <div class="col-md-12">
                        ...
                        <input type="text" name="name" id="name"
                            ...
                            value="{{ old('name') }}" required placeholder="Ej: Editor">
                        @error('name')
        ...
        document.addEventListener('DOMContentLoaded', function () {
            document.querySelectorAll('.select-all-group').forEach(checkbox => {
                checkbox.addEventListener('change', function () {
                    ...
                    group.querySelectorAll('.permission-group-body .custom-control-input').forEach(cb => {
