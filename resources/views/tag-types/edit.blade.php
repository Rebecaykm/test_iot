...
@section('title', 'Editar Tipo de Tag')

@section('content_header')
    <h1>{{ __('Editar Tipo de Tag') }}</h1>
@stop
        ...
        <div class="card-body">
            <form action="{{ route('tag-types.update', $tagType->id) }}" method="POST">
                ...
                <div class="row mb-3">
                    <div class="col-md-6">
                        ...
                        <input type="text" name="name" id="name"
                            ...
                            value="{{ old('name', $tagType->name) }}" required placeholder="Ej: Tipo de Prioridad">
                        @error('name')
                    ...
                    <div class="col-md-6">
                        ...
                        <textarea name="description" id="description" rows="3"
                            ...
                            placeholder="{{ __('Descripción del tipo de tag') }}">{{ old('description', $tagType->description) }}</textarea>
                        @error('description')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                ...
                <div class="d-flex justify-content-end gap-2">
                    <a href="{{ route('tag-types.index') }}" class="btn btn-outline-secondary rounded-3">
