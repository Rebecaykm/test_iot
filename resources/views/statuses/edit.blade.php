...
@section('content_header')
    <div class="d-flex justify-content-between align-items-center flex-wrap gap-3">
        <div>
            <h1 class="m-0 font-weight-bold text-dark" style="font-size: 1.4rem;">Editar Estado</h1>
        </div>
    ...
    <div class="card border-0 shadow-sm rounded-4 overflow-hidden">
        <div class="card-header bg-white py-3" style="border-bottom: 1px solid #e9ecef;">
            <h5 class="mb-0 section-title">
                <i class="fas fa-flag mr-2" style="color: #94a3b8;"></i>Información del Estado
            </h5>
        </div>
                ...
                <div class="row mb-3">
                    <div class="col-md-6 mb-3 mb-md-0">
                        ...
                        <input type="text" name="name" id="name"
                            ...
                            value="{{ old('name', $status->name) }}" required placeholder="Ej: En Proceso">
                        @error('name')
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" name="description" id="description"
                            ...
                            value="{{ old('description', $status->description) }}" placeholder="Descripción del estado">
                        @error('description')
                            <div class="field-error">{{ $message }}</div>
                        @enderror
                    </div>
