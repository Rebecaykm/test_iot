...
@section('content_header')
    <div class="d-flex justify-content-between align-items-center flex-wrap gap-3">
        <div>
            <h1 class="m-0 font-weight-bold text-dark" style="font-size: 1.4rem;">Crear Turno</h1>
        </div>
                ...
                <div class="row mb-3">
                    <div class="col-md-4">
                        ...
                        <input type="text" name="abbreviation" id="abbreviation"
                            ...
                            value="{{ old('abbreviation') }}" maxlength="2" required placeholder="Ej: D, N">
                        @error('abbreviation')
                    ...
                    <div class="col-md-8">
                        ...
                        <input type="text" name="name" id="name"
                            ...
                            value="{{ old('name') }}" required placeholder="Ej: Turno Diurno">
                        @error('name')
                            <div class="field-error">{{ $message }}</div>
                        @enderror
                    </div>
                ...
                <div class="row mb-3">
                    <div class="col-md-12">
                        ...
                        <input type="text" name="description" id="description"
                            ...
                            value="{{ old('description') }}" placeholder="Descripción del turno">
                        @error('description')
                            <div class="field-error">{{ $message }}</div>
                        @enderror
                    </div>
